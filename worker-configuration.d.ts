/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./worker-configuration.d.ts` (hash: 296bbe326ca12890d524667dfcbb052a)
// Runtime types generated with workerd@1.20260828.1 2026-08-17
interface __BaseEnv_CloudflareEnv {
  MEDIA: R2Bucket
  DB: D1Database
  IMAGES: ImagesBinding
  ASSETS: Fetcher
  NEXT_PUBLIC_API_URL: 'https://vinext-starterkit.your-name.workers.dev/api'
  NEXT_PUBLIC_OSM_API_URL: 'https://nominatim.openstreetmap.org'
  BETTER_AUTH_URL: 'https://vinext-starterkit.your-name.workers.dev'
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'NEXT_PUBLIC_API_URL' | 'NEXT_PUBLIC_OSM_API_URL' | 'BETTER_AUTH_URL'>
  > {}
}
