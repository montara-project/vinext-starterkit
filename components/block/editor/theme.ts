...
export const shadcnTheme: LexKitTheme = {
  ...
  placeholder:
    'absolute top-4 left-4 text-xl leading-relaxed select-none text-muted-foreground pointer-events-none z-0',
  ...
  draggable: {
    ...
    upButton:
      'w-6 h-6 bg-background border border-border rounded text-foreground hover:bg-accent hover:text-accent-foreground transition-all duration-200 hover:scale-105 active:scale-95 backdrop-blur-sm',
    downButton:
      'w-6 h-6 bg-background border border-border rounded text-foreground hover:bg-accent hover:text-accent-foreground transition-all duration-200 hover:scale-105 active:scale-95 backdrop-blur-sm',
    buttonStack:
